...
char *SECTION(".data") v800A3D28[] = {
    ...
    ( char[] ){0xB3, 0xB0, 0xC9, 0xF4, 0xB3, 0xE4, 0xA4, 0xEA, 0xB9, 0xFE, 0xA4, 0xDF, 0x00},
    "Mod",
    "TLBL",
    "TLBS",
    /* ロ－ド時アドレスエラ－ (Address Error - Load) */
    ( char[] ){0xA5, 0xED, 0xA1, 0xDD, 0xA5, 0xC9, 0xBB, 0xFE, 0xA5, 0xA2, 0xA5, 0xC9, 0xA5, 0xEC, 0xA5, 0xB9, 0xA5, 0xA8, 0xA5, 0xE9, 0xA1, 0xDD, 0x00},
    /* ストア時アドレスエラ－ (Address Error - Store) */
    ( char[] ){0xA5, 0xB9, 0xA5, 0xC8, 0xA5, 0xA2, 0xBB, 0xFE, 0xA5, 0xA2, 0xA5, 0xC9, 0xA5, 0xEC, 0xA5, 0xB9, 0xA5, 0xA8, 0xA5, 0xE9, 0xA1, 0xDD, 0x00},
    /* 命令バスエラ－ (Instruction Bus Error) */
    ( char[] ){0xCC, 0xBF, 0xCE, 0xE1, 0xA5, 0xD0, 0xA5, 0xB9, 0xA5, 0xA8, 0xA5, 0xE9, 0xA1, 0xDD, 0x00},
    /* デ－タバスエラ－ (Data Bus Error) */
    ( char[] ){0xA5, 0xC7, 0xA1, 0xDD, 0xA5, 0xBF, 0xA5, 0xD0, 0xA5, 0xB9, 0xA5, 0xA8, 0xA5, 0xE9, 0xA1, 0xDD, 0x00},
    /* システムコ－ル (System Call) */
    ( char[] ){0xA5, 0xB7, 0xA5, 0xB9, 0xA5, 0xC6, 0xA5, 0xE0, 0xA5, 0xB3, 0xA1, 0xDD, 0xA5, 0xEB, 0x00},
    /* ブレ－クポイント (Breakpoint) */
    ( char[] ){0xA5, 0xD6, 0xA5, 0xEC, 0xA1, 0xDD, 0xA5, 0xAF, 0xA5, 0xDD, 0xA5, 0xA4, 0xA5, 0xF3, 0xA5, 0xC8, 0x00},
    /* 予約命令 (Reserved Instruction) */
    ( char[] ){0xCD, 0xBD, 0xCC, 0xF3, 0xCC, 0xBF, 0xCE, 0xE1, 0x00},
    /* コプロ (Coprocessor) */
    ( char[] ){0xA5, 0xB3, 0xA5, 0xD7, 0xA5, 0xED, 0x00},
    /* オ－バ－フロ－ (Overflow) */
    ( char[] ){0xA5, 0xAA, 0xA1, 0xDD, 0xA5, 0xD0, 0xA1, 0xDD, 0xA5, 0xD5, 0xA5, 0xED, 0xA1, 0xDD, 0x00},
    "???",
    "???",
    "???",
};
