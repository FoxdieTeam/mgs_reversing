...
void camera_act_helper_helper2_8002F094(int param_1)
{
    ...
    if (param_1 < 6)
    {
        ...
        sub_8002ECE4(&GM_Camera_800B77E8.field_8.vx, &vec.vx, &GM_Camera_800B77E8.field_0);
    ...
    else
    {
        ...
        GV_DirVec3_80016FA0(&GM_Camera_800B77E8.field_10, GM_Camera_800B77E8.field_1C, &vec);
        sub_8002EC8C(&GM_Camera_800B77E8.field_0, &vec.vx, &GM_Camera_800B77E8.field_8.vx);
        GM_Camera_800B77E8.field_28 = 0;
    }
