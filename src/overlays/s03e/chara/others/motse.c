...
extern const char s03e_aMotsec_800CBFDC[];
...
void s03e_motse_800C57CC(MotseWork *work)
{
    MotseElem *elem;
    int        i;
...
void s03e_motse_800C5864(MotseWork *work)
{
    GV_DelayedFree_80016254(work->field_28_elems);
}

int s03e_motse_800C5888(MotseWork *work, int name)
{
    int            i, count;
    unsigned char *param;
    MotseElem     *elems;
...
GV_ACT *s03e_motse_800C5944(int name, int where, int argc, char **argv)
{
    MotseWork *work;
    ...
    if (work != NULL)
    {
        GV_SetNamedActor_8001514C(&work->actor, (TActorFunction)s03e_motse_800C57CC,
                                  (TActorFunction)s03e_motse_800C5864, s03e_aMotsec_800CBFDC);
