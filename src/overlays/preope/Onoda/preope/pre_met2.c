...
typedef struct _PreMet2Work
{
    ...
    DR_TPAGE     field_454;
    DR_TPAGE     field_45C;
    PreMet2Prims field_464[PAGE_COUNT * 8];
    int          field_9584;
    int          field_9588;
    int          field_958C;
    int          field_9590;
...
void PreMet2_800C4FD4(PreMet2Work *work, int index)
{
    ...
    if (work->field_464[i].field_1E0 != NULL)
    {
        ...
        work->field_464[i].field_1E8 = premet2_800C3250[index].field_0;
        work->field_464[i].field_1EA = premet2_800C3250[index].field_2;

        work->field_464[i].field_1FC = 128;
        work->field_464[i].field_1FE = kcb->short3 - 1;
        work->field_464[i].field_1EC = premet2_800C3250[index].field_0 + 256;
        work->field_464[i].field_1EE = premet2_800C3250[index].field_2;
        ...
        if (work->field_464[j].field_1E4 == 1)
        {
            ...
            for (k = 0; k < 8; k += 2)
            {
                *sprt2 = *sprt;
                ...
                sprt2->x0 += premet2_800C3290[k];
                sprt2->y0 += premet2_800C3290[k + 1];
...
void PreMet2_800C5CE4(PreMet2Work *work)
{
    ...
    case 4:
        ...
        else if (work->field_64 == 9)
        {
            for (i = 0; i < 8; i++)
            {
                PreMet2SetColor_800C5738(work, i, get_color(0));
            }
        }
        ...
        else if (work->field_64 == 11)
        {
            for (i = 0; i < 8; i++)
            {
                ...
                PreMet2SetColor_800C5738(work, i, get_color(25));
            }
        }
...
void PreMet2_800C62B0(PreMet2Work *work)
{
    ...
    for (i = 0; i < 8; i++)
    {
        PreMet2SetColor_800C5738(work, i, color);
    }
}
...
GV_ACT *NewPreMet2_800C6F20(int arg0, int *arg1, PreEntries *arg2)
{
    PreMet2Work *work;
    ...
    if (work != NULL)
    {
        GV_SetNamedActor(&work->actor, (GV_ACTFUNC)PreMet2Act_800C65A8,
                         (GV_ACTFUNC)PreMet2Die_800C6634, "pre_met2.c");
