 ...
 * |= 0x10 if Snake runs from sna_init_anim_run_begin_80053B88(), sna_init_anim_run_8005292C(),
 * sna_init_anim_rungun_begin_80056BDC() and sna_init_anim_rungun_80056C3C().
