...
SE_TBL SECTION(".data") se_tbl_800A22C4[128] = {
    {0x01, 0x01, 0x01, 0x00, {SE_END, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A067C, SE_END, SE_END}},
    {0x10, 0x01, 0x01, 0x00, {SE_START, SE_END, SE_END}},
    {0x10, 0x01, 0x01, 0x00, {0x8009FDD8, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0A48, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A1EE0, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A1F08, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A0F14, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A0F90, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0FD4, SE_END, SE_END}},
    {0x30, 0x01, 0x00, 0x00, {0x800A1004, SE_END, SE_END}},
    {0x90, 0x01, 0x00, 0x00, {0x800A1338, SE_END, SE_END}},
    {0xB0, 0x01, 0x00, 0x00, {0x800A13CC, SE_END, SE_END}},
    {0x90, 0x01, 0x00, 0x00, {0x800A1390, SE_END, SE_END}},
    {0x90, 0x01, 0x00, 0x00, {0x800A16E8, SE_END, SE_END}},
    {0xF0, 0x03, 0x00, 0x00, {0x800A1408, 0x800A143C, 0x800A1468}},
    {0x20, 0x01, 0x00, 0x00, {0x800A0410, SE_END, SE_END}},
    {0x90, 0x01, 0x00, 0x00, {0x800A0470, SE_END, SE_END}},
    {0xA0, 0x01, 0x01, 0x01, {0x800A1BBC, SE_END, SE_END}},
    {0xA0, 0x01, 0x01, 0x01, {0x800A06A4, SE_END, SE_END}},
    {0x90, 0x01, 0x01, 0x00, {0x800A088C, SE_END, SE_END}},
    {0x20, 0x01, 0x00, 0x00, {0x800A04C0, SE_END, SE_END}},
    {0x90, 0x02, 0x00, 0x00, {0x800A04F8, 0x800A0528, SE_END}},
    {0x10, 0x01, 0x00, 0x00, {0x800A0580, SE_END, SE_END}},
    {0xA0, 0x01, 0x01, 0x01, {0x800A05D0, SE_END, SE_END}},
    {0xA0, 0x01, 0x01, 0x01, {0x800A05F8, SE_END, SE_END}},
    {0xF0, 0x01, 0x00, 0x01, {0x800A061C, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A0650, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A06C8, SE_END, SE_END}},
    {0x10, 0x01, 0x01, 0x00, {0x800A0EB8, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A0714, SE_END, SE_END}},
    {0x90, 0x01, 0x00, 0x00, {0x800A0738, SE_END, SE_END}},
    {0x90, 0x02, 0x00, 0x00, {0x800A07DC, 0x800A0804, SE_END}},
    {0x90, 0x03, 0x00, 0x00, {0x800A075C, 0x800A078C, 0x800A07B4}},
    {0x90, 0x02, 0x00, 0x00, {0x800A082C, 0x800A0864, SE_END}},
    {0x90, 0x01, 0x01, 0x00, {0x800A0BE0, SE_END, SE_END}},
    {0x20, 0x02, 0x00, 0x00, {0x800A12D8, 0x800A1310, SE_END}},
    {0x60, 0x01, 0x01, 0x00, {0x800A0A6C, SE_END, SE_END}},
    {0x60, 0x01, 0x01, 0x00, {0x8009FDF8, SE_END, SE_END}},
    {0x10, 0x01, 0x01, 0x00, {0x8009FE18, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A0AA8, SE_END, SE_END}},
    {0x90, 0x01, 0x01, 0x00, {0x800A0B18, SE_END, SE_END}},
    {0xA0, 0x01, 0x00, 0x00, {0x800A0300, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x8009FE90, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x8009FED8, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0AEC, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x8009FF14, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x8009FF5C, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A0498, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x8009FF88, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x8009FFAC, SE_END, SE_END}},
    {0x70, 0x01, 0x01, 0x00, {0x800A1608, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A1114, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A10E0, SE_END, SE_END}},
    {0x10, 0x01, 0x00, 0x00, {0x800A21BC, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0B70, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A1098, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A10BC, SE_END, SE_END}},
    {0x90, 0x02, 0x00, 0x00, {0x800A1A8C, 0x800A1B28, SE_END}},
    {0x60, 0x01, 0x01, 0x00, {0x800A0C04, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A004C, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A00B8, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A1034, SE_END, SE_END}},
    {0x60, 0x01, 0x01, 0x00, {0x800A1074, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0204, SE_END, SE_END}},
    {0x90, 0x02, 0x01, 0x00, {0x800A0C74, 0x800A0CA4, SE_END}},
    {0x70, 0x01, 0x01, 0x00, {0x800A1A54, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A21E4, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A2244, SE_END, SE_END}},
    {0x01, 0x00, 0x00, 0x00, {SE_END, SE_END, SE_END}},
    {0x01, 0x00, 0x00, 0x00, {SE_END, SE_END, SE_END}},
    {0x01, 0x00, 0x00, 0x00, {SE_END, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0174, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A1FA0, SE_END, SE_END}},
    {0x80, 0x02, 0x00, 0x00, {0x800A1FD0, 0x800A2000, SE_END}},
    {0xFF, 0x01, 0x00, 0x00, {0x800A2118, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A05A4, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A01A8, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0230, SE_END, SE_END}},
    {0x30, 0x01, 0x00, 0x00, {0x800A0254, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0280, SE_END, SE_END}},
    {0x60, 0x01, 0x01, 0x00, {0x800A02A4, SE_END, SE_END}},
    {0x40, 0x01, 0x01, 0x00, {0x800A02C8, SE_END, SE_END}},
    {0xA0, 0x03, 0x00, 0x00, {0x800A033C, 0x800A0380, 0x800A03C8}},
    {0x80, 0x02, 0x00, 0x00, {0x800A1160, 0x800A1188, SE_END}},
    {0x80, 0x01, 0x00, 0x00, {0x800A09C4, SE_END, SE_END}},
    {0x80, 0x01, 0x00, 0x00, {0x800A09E8, SE_END, SE_END}},
    {0x80, 0x02, 0x00, 0x00, {0x800A11B0, 0x800A11EC, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A08B0, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A08E4, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0918, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0940, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A0978, SE_END, SE_END}},
    {0x30, 0x01, 0x01, 0x00, {0x800A09A0, SE_END, SE_END}},
    {0x10, 0x01, 0x01, 0x00, {0x800A1BF4, SE_END, SE_END}},
    {0x90, 0x01, 0x01, 0x00, {0x800A0C50, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A0CE8, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A0D10, SE_END, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A0D48, SE_END, SE_END}},
    {0x10, 0x01, 0x01, 0x00, {0x800A1138, SE_END, SE_END}},
    {0xFF, 0x03, 0x00, 0x00, {0x800A0DB4, 0x800A0DF4, 0x800A0E6C}},
    {0x40, 0x01, 0x01, 0x00, {0x800A227C, SE_END, SE_END}},
    {0xF0, 0x02, 0x00, 0x00, {0x800A1644, 0x800A167C, SE_END}},
    {0x20, 0x01, 0x00, 0x00, {0x800A122C, SE_END, SE_END}},
    {0x80, 0x01, 0x00, 0x00, {0x800A1278, SE_END, SE_END}},
    {0x80, 0x01, 0x00, 0x00, {0x800A129C, SE_END, SE_END}},
    {0x90, 0x01, 0x00, 0x00, {0x800A16BC, SE_END, SE_END}},
    {0x90, 0x01, 0x00, 0x01, {0x800A1720, SE_END, SE_END}},
    {0x80, 0x02, 0x00, 0x00, {0x800A1758, 0x800A1784, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A17DC, SE_END, SE_END}},
    {0x40, 0x02, 0x01, 0x00, {0x800A1830, 0x800A1860, SE_END}},
    {0x30, 0x02, 0x01, 0x00, {0x800A1888, 0x800A18B8, SE_END}},
    {0x20, 0x01, 0x01, 0x00, {0x800A1904, SE_END, SE_END}},
    {0x30, 0x02, 0x01, 0x00, {0x800A1928, 0x800A1958, SE_END}},
    {0x90, 0x01, 0x00, 0x00, {0x800A1A30, SE_END, SE_END}},
    {0xB0, 0x01, 0x00, 0x00, {0x800A19F8, SE_END, SE_END}},
    {0x40, 0x01, 0x00, 0x00, {0x800A1E50, SE_END, SE_END}},
    {0xB0, 0x01, 0x00, 0x00, {0x800A1E1C, SE_END, SE_END}},
    {0x80, 0x01, 0x00, 0x00, {0x800A1DCC, SE_END, SE_END}},
    {0xB0, 0x01, 0x00, 0x00, {0x800A1DA4, SE_END, SE_END}},
    {0x90, 0x02, 0x00, 0x00, {0x800A1E7C, 0x800A1EB4, SE_END}},
    {0xF0, 0x02, 0x00, 0x00, {0x800A1C20, 0x800A1C64, SE_END}},
    {0xF0, 0x03, 0x00, 0x00, {0x800A1CAC, 0x800A1CD4, 0x800A1CFC}},
    {0xF0, 0x03, 0x00, 0x00, {0x800A2150, 0x800A2174, 0x800A2198}},
    {0x40, 0x02, 0x01, 0x00, {0x800A202C, 0x800A2054, SE_END}},
    {0xF0, 0x02, 0x00, 0x00, {0x800A2074, 0x800A20D8, SE_END}},
    {0xB0, 0x03, 0x00, 0x00, {0x800A1F30, 0x800A1F58, 0x800A1F7C}},
    {0x90, 0x01, 0x00, 0x00, {0x800A18DC, SE_END, SE_END}}
};

int SECTION(".data") spu_ch_tbl_800A2AC8[] = {
    1,       1,      2,      4,      8,       0x10,    0x20,    0x40,    0x80,     0x100,    0x200,    0x400,
    0x800,   0x1000, 0x2000, 0x4000, 0x8000,  0x10000, 0x20000, 0x40000, 0x80000, 0x100000, 0x200000, 0x400000,
    0x800000};
