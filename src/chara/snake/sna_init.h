...
typedef struct Actor_SnaInit
{
    ...
    //    void(__fastcall *field_90C_pWeaponFn)(Actor_SnaInit *);
    void *field_90C_pWeaponFn;

    int field_910;
    int field_914;
    short *field_918_pWeponState;
    ...
    // void(__fastcall *field_9C0)(Actor_SnaInit *);
    void *field_9C0;
    int field_9C4;

    // void(__fastcall *field_9C8)(Actor_SnaInit *, int);
    // void(__fastcall *field_9CC)(Actor_SnaInit *, int);
    void *field_9C8;
    void *field_9CC;
