...
#define CHARA_MOSAIC            0x0065  // source/takabe/mosaic.c
#define CHARA_ASIATO            0x02c4  // source/enemy/asiato.c (足跡 = footprint)
#define CHARA_UNKNOWN_03BF      0x03bf  // ??? (PC-ONLY)
#define CHARA_SHUTER            0x03d9  // source/takabe/shuter.c
...
#define CHARA_VMODEL            0x0a02  // source/thing/vmodel.c (PC-ONLY)
...
#define CHARA_BUBBLE_S          0x1a02  // source/okajima/bubble_s.c
#define CHARA_LAMP              0x1ad3  // source/game/lamp.c
#define CHARA_JOHNNY            0x1ef9  // source/chara/torture/johnny.c
#define CHARA_BG_STAGE          0x1fa5  // source/okajima/photo/bg_stage.c
#define CHARA_PANEL             0x20f2  // source/takabe/panel.c
#define CHARA_TIMER             0x22c6  // source/enemy/timer.c
...
#define CHARA_ELEVATOR          0x2abc  // source/takabe/elevator.c
#define CHARA_WALL_SPA          0x2b24  // source/okajima/wall_spa.c
#define CHARA_SECOND_2D0A       0x2d0a  // source/game/second.c
#define CHARA_NINJA             0x30ba  // source/animal/ninja/ninja.c
#define CHARA_VR2               0x30c8  // source/koba/vr/vr2.c
#define CHARA_PATO_LAMP         0x30ce  // source/okajima/pato_lmp.c
#define CHARA_ZAKO10            0x31e3  // source/animal/zako10/zako10.c
#define CHARA_ZAKO14            0x31e7  // source/animal/zako14/zako14.c
#define CHARA_ZAKO19            0x31ec  // source/animal/zako19/zako19.c
...
#define CHARA_LAND_MINE         0x3c0c  // source/bullet/jirai.c
#define CHARA_KOBA_WINMNGR      0x3d26  // source/koba/vr_slct/winmngr.c
#define CHARA_UNKNOWN_3D78      0x3d78  // (PSX-ONLY)
#define CHARA_PAD_DEMO          0x3ed7  // source/takabe/pad_demo.c
...
#define CHARA_BREATH            0x4170  // source/chara/snake/breath.c
#define CHARA_WAKE              0x41a3  // source/chara/wake/wake.c
#define CHARA_LIFT              0x425f  // source/takabe/lift.c
#define CHARA_HIYOKO            0x42e4  // source/okajima/hiyoko.c
#define CHARA_INFRARED_SENSOR   0x43a0  // source/takabe/ir_cens.c
...
#define CHARA_AB_DEMO1          0x4974  // source/onoda/abst/ab_demo1.c
#define CHARA_AB_DEMO2          0x4975  // source/onoda/abst/ab_demo2.c
#define CHARA_VRGLASS           0x49d2  // source/koba/vr/vrglass.c
#define CHARA_DRUM2             0x4be8  // source/takabe/drum2.c
#define CHARA_VRCLEAR           0x4deb  // source/koba/vr/vrclear.c
#define CHARA_BLOOD_CL          0x4e95  // source/okajima/blood_cl.c
#define CHARA_SNDTST            0x4efc  // source/game/sndtst.c
#define CHARA_UNKNOWN_4F02      0x4f02  // ???
...
#define CHARA_VRBOX2_548E       0x548e  // source/koba/vr/vrbox2.c
#define CHARA_VRBOX2_548F       0x548f  // source/koba/vr/vrbox2.c
#define CHARA_VRBOX_5490        0x5490  // source/koba/vr/vrbox.c
#define CHARA_VRTITLE           0x5667  // source/chara/vrtitle/vrtitle.c
#define CHARA_ABST              0x566f  // source/onoda/abst/abst.c
#define CHARA_CAMERA2           0x56cc  // source/enemy/camera2.c
...
#define CHARA_ZK11ACOM          0x5efa  // source/animal/zako11a/zk11acom.c
#define CHARA_PAPER             0x5f02  // source/takabe/paper.c
#define CHARA_ZK11ECOM          0x5f0a  // source/animal/zako11e/zk11ecom.c
#define CHARA_ZK11FCOM          0x5f0e  // source/animal/zako11f/zk11fcom.c
...
#define CHARA_SNWARP            0x672e  // source/enemy/snwarp.c
...
#define CHARA_BLOOD_BL_6A4C     0x6a4c  // source/okajima/blood_bl.c
...
#define CHARA_MONITOR1          0x6d78  // source/takabe/monitor1.c
#define CHARA_CAMERA            0x6e90  // GV_StrCode( "カメラ" ) source/enemy/camera.c
#define CHARA_WATCHER           0x6e9a  // source/enemy/watcher.c
#define CHARA_PSYOBJ            0x710d  // source/chara/psyco/psyobj.c
#define CHARA_LIFE_UP           0x711f  // source/takabe/life_up.c
#define CHARA_PADDEMO2          0x720d  // source/nobu/vr_demo/paddemo2.c
#define CHARA_SPHERE            0x73ea  // source/thing/sphere.c
#define CHARA_DOOR2             0x73f8  // source/takabe/door2.c
#define CHARA_SNAKE18           0x760e  // source/animal/snake18/snake18.c
#define CHARA_DSMOKE2           0x76bc  // source/chara/rope/dsmoke2.c
#define CHARA_ENV_TEST          0x76fe  // source/takabe/env_test.c (PC-ONLY)
#define CHARA_CHAIR             0x788d  // source/takabe/chair.c
#define CHARA_CINEMA            0x7a05  // source/takabe/cinema.c
...
#define CHARA_LIQUID            0x7bf2  // source/animal/liquid/liquid.c
#define CHARA_ZAKOCOM           0x7cf7  // source/animal/zako/zakocom.c
#define CHARA_WIRE              0x7eca  // source/onoda/s04b/wire.c
#define CHARA_TELOP_SET         0x7ff7  // source/takabe/telop.c
...
#define CHARA_DEMOMNGR          0x8a46  // source/koba/demo/demomngr.c
...
#define CHARA_CROW              0x8e60  // source/okajima/valcan/crow.c
#define CHARA_ZK10COM           0x8e64  // source/animal/zako10/zk10com.c
#define CHARA_GLASS             0x8e70  // source/takabe/glass.c
#define CHARA_ZK14COM           0x8e74  // source/animal/zako14/zk14com.c
#define CHARA_ZK19COM           0x8e88  // source/animal/zako19/zk19com.c
#define CHARA_POCKET_8FDC       0x8fdc  // --> source/menu/pocket.c
#define CHARA_SNOWAREA          0x901e  // source/okajima/snowarea.c
#define CHARA_UNKNOWN_9093      0x9093  // ???
#define CHARA_ITEM_DOT          0x917b  // source/okajima/item_dot.c
#define CHARA_PUTHZD            0x91aa  // source/takabe/puthzd.c
#define CHARA_LIFT2             0x921b  // source/takabe/lift2.c (PC-ONLY)
...
#define CHARA_GODZCOM           0x9eb7  // source/animal/godzila/godzcom.c
#define CHARA_DISPLAY           0x9f7d  // source/chara/pocket/display/display.c
#define CHARA_VALCAN            0x9ff5  // source/okajima/valcan/valcan.c
...
#define CHARA_CRANE             0xa3fb  // source/okajima/crane.c
...
#define CHARA_ZAKO11A           0xa608  // source/animal/zako11a/zako11a.c
#define CHARA_ZAKO11E           0xa60c  // source/animal/zako11e/zako11e.c
#define CHARA_ZAKO11F           0xa60d  // source/animal/zako11f/zako11f.c
#define CHARA_SSTORM            0xa6f5  // source/kojo/sstorm.c
#define CHARA_UNKNOWN_A6F6      0xa6f6  // --> kmdarutl.c
#define CHARA_PSYCO             0xa76f  // source/chara/psyco/psyco.c
...
#define CHARA_DYNAMIC_FLOOR     0xaf6c  // source/takabe/dymc_flr.c
...
#define CHARA_DYNAMIC_SEGMENT   0xb103  // source/takabe/dymc_seg.c
...
#define CHARA_CANCEL            0xb4e6  // source/game/cancel.c
#define CHARA_DRUM              0xb58d  // source/takabe/drum.c
...
#define CHARA_SPHERE2           0xbee1  // source/thing/sphere2.c
...
#define CHARA_VRCLEAR2          0xc249  // source/koba/vr/vrclear2.c
#define CHARA_VRCLEAR3          0xc24a  // source/koba/vr/vrclear3.c (?) (PC-ONLY)
...
#define CHARA_COMMAND           0xc6d7  // source/enemy/command.c
...
#define CHARA_GODZILA           0xcb1f  // source/animal/godzila/godzila.c
#define CHARA_TRACK_TRAP        0xcb3a  // source/takabe/tracktrp.c
#define CHARA_BG_HEX            0xcbeb  // source/okajima/photo/bg_hex.c (PC-ONLY)
#define CHARA_PAD               0xcbf8  // source/game/pad.c
#define CHARA_DYNCON            0xcc45  // source/okajima/valcan/dyncon.c
...
#define CHARA_OPEN              0xcf79  // source/onoda/open/open.c
#define CHARA_OPENP             0xcfef  // source/onoda/openp/openp.c
#define CHARA_BACKGROUND        0xd07f  // source/koba/vr/backgrnd.c
#define CHARA_SELECT            0xd2f6  // source/game/select.c
#define CHARA_UNKNOWN_D3C0      0xd3c0  // ???
#define CHARA_VRWINDOW          0xd44e  // source/koba/vr/vrwindow.c
...
#define CHARA_GOAL              0xdb1f  // source/koba/vr/goal.c
...
#define CHARA_PANEL2            0xdd95  // source/takabe/panel2.c
#define CHARA_VRBOX_DF07        0xdf0f  // source/koba/vr/vrbox.c
...
#define CHARA_DOLL              0xe97e  // source/animal/doll/doll.c
#define CHARA_WALL              0xec77  // source/enemy/wall.c
#define CHARA_PAUSE             0xeced  // --> source/menu/countdwn.c
#define CHARA_VR                0xed86  // source/koba/vr/vr.c
#define CHARA_ZAKO              0xed87  // source/animal/zako/zako.c
...
#define CHARA_MERYL07B          0xf4b0  // source/chara/meryl07b/meryl07b.c
#define CHARA_PUT_OBJECT        0xf4c3  // source/takabe/put_obj.c
#define CHARA_SEARCH_LIGHT      0xf50f  // source/enemy/searchli.c
...
#define CHARA_VIBRATE           0xfed1  // source/game/vibrate.c
