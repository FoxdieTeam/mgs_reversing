...
char SECTION(".sbss") byte_800ABA13;
short SECTION(".sbss") word_800ABA14;
...
int SECTION(".sbss") word_800ABA2C;
...
int SECTION(".sbss") dword_800ABB0C[21];
int SECTION(".sbss") dword_800ABB60[2];
int SECTION(".sbss") dword_800ABB68[2];
int SECTION(".sbss") dword_800ABB70;
int SECTION(".sbss") dword_800ABB74;
int SECTION(".sbss") dword_800ABB78[16];

int SECTION(".sbss") dword_800ABBB8[7];

short SECTION(".sbss") word_800ABBD4[2];
int SECTION(".sbss") dword_800ABBD8;
short SECTION(".sbss") word_800ABBDC[2];
int SECTION(".sbss") dword_800ABBE0[2];
