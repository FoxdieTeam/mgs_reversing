...
void                 *LoadInit_80083F08( unsigned short );
int                   SD_80083ED4();
void                 *SD_80083EE8( unsigned short );
void                 *SD_SngDataLoadInit_80083E8C( unsigned short );
int                   SD_Unload_800843BC();

extern int            SD_WavLoadBuf_800841D4;
extern char           aDCCD;
extern char           aHere;
extern char           aWrongMode02xC;
extern int           *dword_8009D4F8;
extern int ( *dword_8009D4FC )();
    ...
    case 's':
        ...
        case 'w':
            if ( dword_8009D500[ word_8009D504 ] != config->field_0_hash )
            {
                ...
                dword_8009D4FC = SD_Unload_800843BC;
                dword_8009D4F8 = &SD_WavLoadBuf_800841D4;
