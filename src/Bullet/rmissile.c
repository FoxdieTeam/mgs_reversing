...
void rmissile_act_8006C5C4(Actor_rmissile *pActor)
{
    ...
    else
    {
        ...
        else
        {
            ...
            GV_NearTimeSV_800268AC(&pActor->field_16C_svector.vx, &GM_PlayerPosition_800ABA10.vx, pActor->field_16A, 3);
        ...
        else
        {
            ...
            GV_DirVec2_80016F24(pActor->field_20_ctrl.field_8_rot.vy, pActor->field_11A, &pActor->field_20_ctrl.field_44_step);
...
int rmissile_loader_8006CF44(Actor_rmissile *pActor, MATRIX *pMtx, int whichSide)
{
    ...
    pActor->field_108_svector = GM_PlayerPosition_800ABA10;
