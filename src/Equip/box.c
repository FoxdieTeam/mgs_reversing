...
#pragma INCLUDE_ASM("asm/Equip/BoxCheckMessage_8006195C.s")
int BoxCheckMessage_8006195C(Actor_Box *pActor);

#pragma INCLUDE_ASM("asm/Equip/BoxAct_80061A14.s")
void BoxAct_80061A14(Actor_Box *pActor);

#pragma INCLUDE_ASM("asm/Equip/BoxDie_80061B30.s")
void BoxDie_80061B30(Actor_Box *pActor);

#pragma INCLUDE_ASM("asm/Equip/BoxGetResources_80061BA0.s")
