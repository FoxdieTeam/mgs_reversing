...
def ninja_run():
    ...
    warning_whitelist = [
        ...
        r'sphere2.c:\d+: warning: `xoff\' might be used uninitialized in this function',
        r'sphere2.c:\d+: warning: `yoff\' might be used uninitialized in this function',
        r'sphere2.c:\d+: warning: `tpage\' might be used uninitialized in this function',
        r'sphere2.c:\d+: warning: `clut\' might be used uninitialized in this function',
        r'sphere2.c:\d+: warning: `u0\' might be used uninitialized in this function',
        r'sphere2.c:\d+: warning: `v0\' might be used uninitialized in this function',
        r'sphere2.c:\d+: warning: `u1\' might be used uninitialized in this function',
        r'sphere2.c:\d+: warning: `v1\' might be used uninitialized in this function',
        # in takabe
...
def get_file_global_size(file):
    ...
    if any(i in file for i in global_list):
        return "8"
