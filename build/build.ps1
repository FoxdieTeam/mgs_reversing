...
function compile_c($fileName)
{
    ...
    if ($upToDate -eq $false)
    {
        ...
        ccpsx.exe -O2 -g -c -Wall "$fileName" "-o$objName" -I  $PSScriptRoot\..\src -I  $PSScriptRoot\..\src\data\data -I $PSScriptRoot\..\src\data\rdata -I $PSScriptRoot\..\src\data\sdata -I  $PSScriptRoot\..\src\libgv -I  $PSScriptRoot\..\src\libgcl -I $PSScriptRoot\..\src\libdg -I $PSScriptRoot\..\src\Game -I $PSScriptRoot\..\src\Menu
