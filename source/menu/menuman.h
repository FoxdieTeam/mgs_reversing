...
// void menu_draw_sight(MenuWork *work, char *ot, RADAR_SIGHT_PARAM *r_param, int x, int y, int color, int fadeColor, int scale);
// void draw_radar_frame(MenuWork *menuMan, unsigned char *ot);
// void menu_draw_radar(MenuWork *work, unsigned char *ot, int arg2);
...
// void menu_radar_draw_state(MenuWork *work, char *ot, int radarMode, int alertLevel);
...
PANEL_TEXTURE *get_panel_tex(int idx);
void menu_item_printDescription_8003B614(int itemIndex);
int is_disable_item(int item_idx);
...
void menu_item(MenuWork *menuMan, u_long *ot);
