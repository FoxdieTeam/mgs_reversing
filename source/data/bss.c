...
/* game/target.obj */
TARGET BSS          GM_TargetDatas[TARGET_MAX]; // 0x1200 (4608) bytes

/* game/alert.obj */
char BSS            noise_sounds[4][3]; // 0xC (12) bytes
...
GM_SnakeCameraWork BSS GM_SnakeCamera; // 0x30 (48) bytes
GM_CameraSystemWork BSS GM_Camera; // 0x7C (124) bytes
