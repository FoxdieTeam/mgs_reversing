...
int HdBul2_800C5C68( HdBul2Work *work, SVECTOR *arg1 )
{
    ...
    if ( HZD_OnlineHazardCheck( work->control.map->hzd, &sp18, &sp20, HZD_CHK_FIX, SEGMENT_ATR ) )
    {
...
int HdBul2GetResources( HdBul2Work *work, SVECTOR *arg1, SVECTOR *arg2 )
{
    ...
    GM_SetPowerTarget( target, POWER_ONCE, 1, GM_VitalityMax / 8, 0, &DG_ZeroVector );
...
void *NewHdBul2( SVECTOR *arg0, SVECTOR *arg1, int enable )
{
    ...
    work = GV_NewActor( GV_ACTOR_USER, sizeof(HdBul2Work) );
    if ( work )
    {
