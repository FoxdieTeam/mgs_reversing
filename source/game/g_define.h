...
enum {
    ...
    STATE_LIFE_OFF = 0x20000,
    STATE_EQUIP_OFF = 0x40000,
    STATE_MENU_DISABLE = 0x80000,
...
#define STATE_CAM_CHANGE    ( STATE_BEHIND_CAMERA | STATE_CUT_IN )
#define STATE_ALL_OFF       ( STATE_RADAR_OFF | STATE_MENU_DISABLE | STATE_LIFE_OFF | STATE_PAUSE_OFF | STATE_RADIO_OFF )  // 0x4A6000
#define STATE_PAUSE_ONLY    ( STATE_RADAR_OFF | STATE_MENU_DISABLE | STATE_LIFE_OFF | STATE_RADIO_OFF )                    // 0x4A2000
