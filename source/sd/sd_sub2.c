...
void lp1_end(void)
{
    ...
    if (stop_jouchuu_se_800BF1A0 && !mdata2)
    {
        sptr->lp1_vol = 0;
        sptr->lp1_freq = 0;
...
void ads_set(void)
{
    ...
    spu_tr_wk_800C0658[mtrack_800BF1EC].ar = ~mdata2 & 0x7F;
    spu_tr_wk_800C0658[mtrack_800BF1EC].dr = ~mdata3 & 0xF;
    spu_tr_wk_800C0658[mtrack_800BF1EC].sl = mdata4 & 0xF;
...
void srs_set(void)
{
    ...
    spu_tr_wk_800C0658[mtrack_800BF1EC].sr = ~mdata2 & 0x7F;
