...
static int GetResources(Work *work, MATRIX *world)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        prim = GM_MakePrim(DG_PRIM_RECTANGLE | DG_PRIM_ON_CAMERA | DG_PRIM_POLY_FT4, 1, &work->field_A0_vecs[i], &work->field_20[i]);
...
static const int anm_stn_g_sonic_form_script[] = {
...
static const int anm_stun_g_center_form_script[] = {
