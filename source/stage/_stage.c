...
// NOTE: This table was reversed from the PC port's main executable (mgsi.exe)
...
CHARA _StageCharacterEntries[] = {
    { 0x002a, NULL },   //  CHARA_002A_BLACKSMOKE,
    { 0x002f, NULL },   //  CHARA_002F_BLACKSMOKE2,
    { 0x0030, NULL },   //  CHARA_0030_BLASTLINE,
    { 0x0009, NULL },   //  CHARA_0009_BLOOD,
    { 0x000d, NULL },   //  CHARA_000D_BLOODCIRCLE,
    { 0x0048, NULL },   //  CHARA_0048_BLOODDRIP,
    { 0x0047, NULL },   //  CHARA_0047_BLOODHAZARD,
    { 0x000a, NULL },   //  CHARA_000A_BLOOD2,
    { 0x0025, NULL },   //  CHARA_0025_BLUR,
    { 0x004a, NULL },   //  CHARA_004A_BOMBLIGHT,
    { 0x000e, NULL },   //  CHARA_000E_BREATH,
    { 0x0012, NULL },   //  CHARA_0012_BUBBLE,
    { 0x0013, NULL },   //  CHARA_0013_BUBBLE2,
    { 0x000b, NULL },   //  CHARA_000B_BULLET,
    { 0x0033, NULL },   //  CHARA_0033_CATERPILLERSMOKE,
    { 0x003a, NULL },   //  CHARA_003A_CELOFAN,
    { 0x0040, NULL },   //  CHARA_0040_CELOFAN2,
    { 0x0039, NULL },   //  CHARA_0039_CRASHSMOKE,
    { 0x0034, NULL },   //  CHARA_0034_CROWEYE,
    { 0x0015, NULL },   //  CHARA_0015_DARKVISIBLEGOGGLE,
    { 0x0016, NULL },   //  CHARA_0016_DARKVISIBLEGOGGLE2,
    { 0x0037, NULL },   //  CHARA_0037_ENVIRONMENTLIGHT,
    { 0x0038, NULL },   //  CHARA_0038_ENVIRONMENTLIGHT2,
    { 0x001c, NULL },   //  CHARA_001C_ENVIRONMENTMAPPING,
    { 0x0001, NULL },   //  CHARA_0001_EXPLOSION,
    { 0x0003, NULL },   //  CHARA_0003_FADEIN,
    { 0x0004, NULL },   //  CHARA_0004_FADEOUT,
    { 0x0045, NULL },   //  CHARA_0045_FAMASLIGHT,
    { 0x0010, NULL },   //  CHARA_0010_FOOTPRINTS,
    { 0x0044, NULL },   //  CHARA_0044_GHOST,
    { 0x0019, NULL },   //  CHARA_0019_GUNSMOKE,
    { 0x0042, NULL },   //  CHARA_0042_GUSEFFECT,
    { 0x0022, NULL },   //  CHARA_0022_GUSMASK,
    { 0x0046, NULL },   //  CHARA_0046_HUMANSHADOW,
    { 0x003b, NULL },   //  CHARA_003B_INVERSLIGHT,
    { 0x003f, NULL },   //  CHARA_003F_INVERSLIGHT2,
    { 0x0017, NULL },   //  CHARA_0017_IRRAYSGOGGLE,
    { 0x0018, NULL },   //  CHARA_0018_IRRAYSGOGGLE2,
    { 0x0020, NULL },   //  CHARA_0020_METALGEARLASER,
    { 0x004b, NULL },   //  CHARA_004B_MGCROOMDISPLAY,
    { 0x000c, NULL },   //  CHARA_000C_MISSILESMOKE,
    { 0x0028, NULL },   //  CHARA_0028_MONOTONE,
    { 0x0011, NULL },   //  CHARA_0011_NINJAEYE,
    { 0x0049, NULL },   //  CHARA_0049_NINJAGROUND,
    { 0x0041, NULL },   //  CHARA_0041_NINJALASER,
    { 0x002d, NULL },   //  CHARA_002D_NINJASWORD,
    { 0x0035, NULL },   //  CHARA_0035_OCEROTTEBULLETFIRE,
    { 0x0036, NULL },   //  CHARA_0036_OCEROTTEBULLETSMOKE,
    { 0x001a, NULL },   //  CHARA_001A_OPTICSCAMOUFLAGE,
    { 0x001b, NULL },   //  CHARA_001B_OPTICSCAMOUFLAGE2,
    { 0x001d, NULL },   //  CHARA_001D_PLASMA,
    { 0x0024, NULL },   //  CHARA_0024_PLASMA2,
    { 0x0007, NULL },   //  CHARA_0007_QUESTIONMARK,
    { 0x0029, NULL },   //  CHARA_0029_RIFLESIGHT,
    { 0x0014, NULL },   //  CHARA_0014_SCOPE,
    { 0x001f, NULL },   //  CHARA_001F_SEPIA,
    { 0x000f, NULL },   //  CHARA_000F_SHADOW,
    { 0x0032, NULL },   //  CHARA_0032_SHELLSMOKE,
    { 0x002c, NULL },   //  CHARA_002C_SIGHT,
    { 0x0008, NULL },   //  CHARA_0008_SLEEPMARK,
    { 0x0002, NULL },   //  CHARA_0002_SMOKE,
    { 0x0031, NULL },   //  CHARA_0031_SMOKELINE,
    { 0x003c, NULL },   //  CHARA_003C_SPACK,
    { 0x003d, NULL },   //  CHARA_003D_SPACK2,
    { 0x003e, NULL },   //  CHARA_003E_STEAMEXPLOSION,
    { 0x0026, NULL },   //  CHARA_0026_STEAMSMOKE,
    { 0x0027, NULL },   //  CHARA_0027_STEAMSMOKE2,
    { 0x002e, NULL },   //  CHARA_002E_SUBMARINEROOM,
    { 0x0043, NULL },   //  CHARA_0043_SUBMARINEWATER,
    { 0x0006, NULL },   //  CHARA_0006_SURPRISEDMARK,
    { 0x0005, NULL },   //  CHARA_0005_TEXT,
    { 0x004c, NULL },   //  CHARA_004C_TEXT2,
    { 0x0021, NULL },   //  CHARA_0021_UNSHAPEVIEW,
    { 0x0023, NULL },   //  CHARA_0023_URINATIONCIRCLE,
    { 0x002b, NULL },   //  CHARA_002B_URINATIONCIRCLE2,
    { 0x001e, NULL },   //  CHARA_001E_WINDCIRCLE,
    ...
    { 0xc73e, NULL },   //  CHARA_FALLSPLASH,   /* chara 滝しぶき */
