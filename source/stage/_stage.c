...
CHARA _StageCharacterEntries[] = {
    { 0x002a, NULL },   //  DEMO_BLACKSMOKE,
    { 0x002f, NULL },   //  DEMO_BLACKSMOKE2,
    { 0x0030, NULL },   //  DEMO_BLASTLINE,
    { 0x0009, NULL },   //  DEMO_BLOOD,
    { 0x000d, NULL },   //  DEMO_BLOODCIRCLE,
    { 0x0048, NULL },   //  DEMO_BLOODDRIP,
    { 0x0047, NULL },   //  DEMO_BLOODHAZARD,
    { 0x000a, NULL },   //  DEMO_BLOOD2,
    { 0x0025, NULL },   //  DEMO_BLUR,
    { 0x004a, NULL },   //  DEMO_BOMBLIGHT,
    { 0x000e, NULL },   //  DEMO_BREATH,
    { 0x0012, NULL },   //  DEMO_BUBBLE,
    { 0x0013, NULL },   //  DEMO_BUBBLE2,
    { 0x000b, NULL },   //  DEMO_BULLET,
    { 0x0033, NULL },   //  DEMO_CATERPILLERSMOKE,
    { 0x003a, NULL },   //  DEMO_CELOFAN,
    { 0x0040, NULL },   //  DEMO_CELOFAN2,
    { 0x0039, NULL },   //  DEMO_CRASHSMOKE,
    { 0x0034, NULL },   //  DEMO_CROWEYE,
    { 0x0015, NULL },   //  DEMO_DARKVISIBLEGOGGLE,
    { 0x0016, NULL },   //  DEMO_DARKVISIBLEGOGGLE2,
    { 0x0037, NULL },   //  DEMO_ENVIRONMENTLIGHT,
    { 0x0038, NULL },   //  DEMO_ENVIRONMENTLIGHT2,
    { 0x001c, NULL },   //  DEMO_ENVIRONMENTMAPPING,
    { 0x0001, NULL },   //  DEMO_EXPLOSION,
    { 0x0003, NULL },   //  DEMO_FADEIN,
    { 0x0004, NULL },   //  DEMO_FADEOUT,
    { 0x0045, NULL },   //  DEMO_FAMASLIGHT,
    { 0x0010, NULL },   //  DEMO_FOOTPRINTS,
    { 0x0044, NULL },   //  DEMO_GHOST,
    { 0x0019, NULL },   //  DEMO_GUNSMOKE,
    { 0x0042, NULL },   //  DEMO_GUSEFFECT,
    { 0x0022, NULL },   //  DEMO_GUSMASK,
    { 0x0046, NULL },   //  DEMO_HUMANSHADOW,
    { 0x003b, NULL },   //  DEMO_INVERSLIGHT,
    { 0x003f, NULL },   //  DEMO_INVERSLIGHT2,
    { 0x0017, NULL },   //  DEMO_IRRAYSGOGGLE,
    { 0x0018, NULL },   //  DEMO_IRRAYSGOGGLE2,
    { 0x0020, NULL },   //  DEMO_METALGEARLASER,
    { 0x004b, NULL },   //  DEMO_MGCROOMDISPLAY,
    { 0x000c, NULL },   //  DEMO_MISSILESMOKE,
    { 0x0028, NULL },   //  DEMO_MONOTONE,
    { 0x0011, NULL },   //  DEMO_NINJAEYE,
    { 0x0049, NULL },   //  DEMO_NINJAGROUND,
    { 0x0041, NULL },   //  DEMO_NINJALASER,
    { 0x002d, NULL },   //  DEMO_NINJASWORD,
    { 0x0035, NULL },   //  DEMO_OCEROTTEBULLETFIRE,
    { 0x0036, NULL },   //  DEMO_OCEROTTEBULLETSMOKE,
    { 0x001a, NULL },   //  DEMO_OPTICSCAMOUFLAGE,
    { 0x001b, NULL },   //  DEMO_OPTICSCAMOUFLAGE2,
    { 0x001d, NULL },   //  DEMO_PLASMA,
    { 0x0024, NULL },   //  DEMO_PLASMA2,
    { 0x0007, NULL },   //  DEMO_QUESTIONMARK,
    { 0x0029, NULL },   //  DEMO_RIFLESIGHT,
    { 0x0014, NULL },   //  DEMO_SCOPE,
    { 0x001f, NULL },   //  DEMO_SEPIA,
    { 0x000f, NULL },   //  DEMO_SHADOW,
    { 0x0032, NULL },   //  DEMO_SHELLSMOKE,
    { 0x002c, NULL },   //  DEMO_SIGHT,
    { 0x0008, NULL },   //  DEMO_SLEEPMARK,
    { 0x0002, NULL },   //  DEMO_SMOKE,
    { 0x0031, NULL },   //  DEMO_SMOKELINE,
    { 0x003c, NULL },   //  DEMO_SPACK,
    { 0x003d, NULL },   //  DEMO_SPACK2,
    { 0x003e, NULL },   //  DEMO_STEAMEXPLOSION,
    { 0x0026, NULL },   //  DEMO_STEAMSMOKE,
    { 0x0027, NULL },   //  DEMO_STEAMSMOKE2,
    { 0x002e, NULL },   //  DEMO_SUBMARINEROOM,
    { 0x0043, NULL },   //  DEMO_SUBMARINEWATER,
    { 0x0006, NULL },   //  DEMO_SURPRISEDMARK,
    { 0x0005, NULL },   //  DEMO_TEXT,
    { 0x004c, NULL },   //  DEMO_TEXT2,
    { 0x0021, NULL },   //  DEMO_UNSHAPEVIEW,
    { 0x0023, NULL },   //  DEMO_URINATIONCIRCLE,
    { 0x002b, NULL },   //  DEMO_URINATIONCIRCLE2,
    { 0x001e, NULL },   //  DEMO_WINDCIRCLE,
    ...
    { 0xa12e, NULL },   //  CHARA_FADEIO,       /* chara フェードイン・アウト */
