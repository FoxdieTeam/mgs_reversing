...
CHARA _StageCharacterEntries[] = {
    ...
    { 0xd5ec, (NEWCHARA)0x800e1134 },   //  CHARA_M1E1CAME,
    { 0x03d9, (NEWCHARA)0x800cf0f0 },   //  CHARA_SHUTTER,      /* chara シャッター */
    ...
    { 0x0003, (NEWCHARA)0x800cfaf4 },   //  CHARA_0003_FADEIN,
    { 0x0004, (NEWCHARA)0x800cfaf4 },   //  CHARA_0004_FADEOUT,
    { 0x0005, (NEWCHARA)0x800d0460 },   //  CHARA_0005_TEXT,
    { 0x000c, (NEWCHARA)0x8005e258 },   //  CHARA_000C_MISSILESMOKE,
    { 0x000f, (NEWCHARA)0x800c7ff8 },   //  CHARA_000F_SHADOW,
    { 0x0021, (NEWCHARA)0x800d1408 },   //  CHARA_0021_UNSHAPEVIEW,
    { 0x0025, (NEWCHARA)0x800ccc3c },   //  CHARA_0025_BLUR,
    { 0x002f, (NEWCHARA)0x800c4574 },   //  CHARA_002F_BLACKSMOKE2,
    { 0x0030, (NEWCHARA)0x800cbb28 },   //  CHARA_0030_BLASTLINE,
    { 0x0031, (NEWCHARA)0x800cd244 },   //  CHARA_0031_SMOKELINE,
    { 0x0032, (NEWCHARA)0x800dbf58 },   //  CHARA_0032_SHELLSMOKE,
    { 0x0044, (NEWCHARA)0x800cc138 },   //  CHARA_0044_GHOST,
