...
CHARA _StageCharacterEntries[] = {
    ...
    { 0x0002, (NEWCHARA)0x800c40c8 },   //  CHARA_0002_SMOKE,
    { 0x0003, (NEWCHARA)0x800d6004 },   //  CHARA_0003_FADEIN,
    { 0x0004, (NEWCHARA)0x800d6004 },   //  CHARA_0004_FADEOUT,
    { 0x0009, (NEWCHARA)0x80072728 },   //  CHARA_0009_BLOOD,
    { 0x000a, (NEWCHARA)0x800c6234 },   //  CHARA_000A_BLOOD2,
    { 0x000d, (NEWCHARA)0x800c6dc0 },   //  CHARA_000D_BLOODCIRCLE,
    { 0x000e, (NEWCHARA)0x800c3f68 },   //  CHARA_000E_BREATH,
    { 0x000f, (NEWCHARA)0x800c5600 },   //  CHARA_000F_SHADOW,
    { 0x0021, (NEWCHARA)0x800d73d8 },   //  CHARA_0021_UNSHAPEVIEW,
    { 0x0025, (NEWCHARA)0x800c8f98 },   //  CHARA_0025_BLUR,
    { 0x0028, (NEWCHARA)0x800d7a20 },   //  CHARA_0028_MONOTONE,
    { 0x0031, (NEWCHARA)0x800c95a0 },   //  CHARA_0031_SMOKELINE,
    { 0x0037, (NEWCHARA)0x800c7e44 },   //  CHARA_0037_ENVIRONMENTLIGHT,
    { 0x0038, (NEWCHARA)0x800c7f08 },   //  CHARA_0038_ENVIRONMENTLIGHT2,
    { 0x0044, (NEWCHARA)0x800c8494 },   //  CHARA_0044_GHOST,
