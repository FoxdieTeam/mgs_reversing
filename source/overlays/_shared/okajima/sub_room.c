...
int SubRoomGetResources_800C7B94(SubRoomWork *work)
{
    ...
    prim = GM_MakePrimChanl(DG_PRIM_POLY_FT4, 2, (SVECTOR *)work->verts1, NULL, 0);
    work->prim1 = prim;
    if (prim == NULL)
    {
        return -1;
    ...
    prim = GM_MakePrimChanl(DG_PRIM_POLY_FT4, 32, (SVECTOR *)work->verts2, NULL, 0);
    work->prim2 = prim;
    if (prim == NULL)
    {
        return -1;
    ...
    prim = GM_MakePrimChanl(DG_PRIM_POLY_FT4, 5, (SVECTOR *)work->verts3, NULL, 0);
    work->prim3 = prim;
    if (prim == NULL)
    {
        return -1;
    ...
    prim = GM_MakePrimChanl(DG_PRIM_POLY_FT4, 2, (SVECTOR *)work->verts4, NULL, 0);
    work->prim4 = prim;
    if (prim == NULL)
    {
        return -1;
