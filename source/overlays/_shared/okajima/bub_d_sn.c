...
int BubbleDisplaySceneGetResources_800D8C90(BubDSnWork *work, int where)
{
    ...
    prim = GM_MakePrimChanl(DG_PRIM_OFFSET | DG_PRIM_POLY_FT4, 4, work->field_34, &work->field_15C, 0);
    ...
    prim = GM_MakePrimChanl(DG_PRIM_OFFSET | DG_PRIM_POLY_FT4, 16, work->field_54, &work->field_164, 0);
    ...
    prim = GM_MakePrimChanl(DG_PRIM_OFFSET | DG_PRIM_POLY_FT4, 16, work->field_D4, &work->field_16C, 0);
