...
extern const char s03d_dword_800DB548[];
extern const char s03d_dword_800DB550[];
extern const char s03d_dword_800DB558[];
...
int s03d_800CDE1C(Work *work)
{
    ...
    rp_shift = *(SVECTOR *)s03d_dword_800DB548;
    force    = *(SVECTOR *)s03d_dword_800DB550;
    size     = *(SVECTOR *)s03d_dword_800DB558;
