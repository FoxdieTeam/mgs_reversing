...
int s14e_dword_800C3310 = 0x00000BB8;
int s14e_dword_800C3314 = 0x00000FA0;
int s14e_dword_800C3318 = 0x00001B58;
int s14e_dword_800C331C = 0x00001F40;
int s14e_dword_800C3320 = 0x00001F40;
int s14e_dword_800C3324 = 0x00001F40;
int s14e_dword_800C3328 = 0x00001F40;
int s14e_dword_800C332C = 0x00001F40;
...
const char s14e_dword_800DC940[] = "Err not enough work !!\n";
const char s14e_dword_800DC958[] = " low[pory=%d\n";
const char s14e_dword_800DC968[] = "watchar.c : action point Err\n";
const char s14e_dword_800DC988[] = "zako14.c";
...
#pragma INCLUDE_ASM("asm/overlays/s14e/s14e_800C62E0.s")
#pragma INCLUDE_ASM("asm/overlays/s14e/s14e_800C66CC.s")
