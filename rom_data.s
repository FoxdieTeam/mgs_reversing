...
aSlpm86248:     db "SLPM_862.48", 0x0  ; DATA XREF: TEXT:8009D300?o
aSlpm86247:     db "SLPM_862.47", 0x0  ; DATA XREF: TEXT:off_8009D2FC?o
aBislpm86247:   db "BISLPM-86247", 0x0
                                         ; DATA XREF: TEXT:off_800AB2EC?o
                db 0, 0, 0
aDsreadycallbac:db "DsReadyCallback %x", 0xA, 0x0
                                         ; DATA XREF: TEXT:80014AD8?o
aDsdatacallback:db "DsDataCallback %x", 0xA, 0x0
                                         ; DATA XREF: TEXT:80014B00?o
                db 0
aHangupS:       db "HANGUP: %s", 0xA, 0x0
                                         ; DATA XREF: sub_80014B34+18?o
aResidentTopX:  db "RESIDENT TOP %X", 0xA, 0x0
                                         ; DATA XREF: sub_80014C70+44?o
                db 0, 0, 0
aDumpactorsyste:db "--DumpActorSystem--", 0xA, 0x0
                                         ; DATA XREF: TEXT:80014E3C?o
                db 0, 0, 0
aLvDPauseDKillD:db "Lv %d Pause %d Kill %d", 0xA, 0x0
                                         ; DATA XREF: TEXT:loc_80014E64?o
aLvD04d02d08xS: db "Lv%d %04d.%02d %08X %s", 0xA, 0x0
                                         ; DATA XREF: TEXT:80014F04?o
aIdConflict:    db "id conflict", 0xA, 0x0
                                         ; DATA XREF: sub_800155BC+9C?o
                db 0, 0, 0
aAssertionFaile:db "Assertion failed: %s, line %d", 0xA, 0x0
                                         ; DATA XREF: TEXT:800156F4?o
                db 0
aSystemD:       db "system %d ( ", 0x0
                                         ; DATA XREF: TEXT:80015C00?o
                                         ; TEXT:80015D50?o
                db 0, 0, 0
aDynamic:       db "dynamic ", 0x0     ; DATA XREF: TEXT:80015C48?o
                                         ; TEXT:loc_80015DA0?o
                db 0, 0, 0
aAddr08x08xUnit:db "  addr = %08x - %08x, units = %d", 0xA, 0x0
                                         ; DATA XREF: TEXT:80015CAC?o
                dh 0
aFreeDDVoidedDM:db "  free = %d / %d, voided = %d, max_free = %d", 0xA, 0x0
                                         ; DATA XREF: TEXT:loc_80015D28?o
                dh 0
a8dBytesFrom08x:db "---- %8d bytes ( from %08x free )", 0xA, 0x0
                                         ; DATA XREF: TEXT:80015E30?o
                db 0
a8dBytesFrom08x_0:db "==== %8d bytes ( from %08x void )", 0xA, 0x0
                                         ; DATA XREF: TEXT:80015E50?o
                db 0
a8dBytesFrom08x_1:db "++++ %8d bytes ( from %08x used )", 0xA, 0x0
                                         ; DATA XREF: TEXT:80015E6C?o
                db 0
a8dBytesFrom08x_2:db "**** %8d bytes ( from %08x user %08x )", 0xA, 0x0
                                         ; DATA XREF: TEXT:80015E80?o
aResidentMemory:db "Resident Memory Over !!", 0xA, 0x0
                                         ; DATA XREF: sub_800163D8+3C?o
                db 0, 0, 0
asc_80010208:   db "@", 0x0            ; DATA XREF: sub_8001F014+40?o
                dh 0
aObjectQueueD:  db "Object Queue %d", 0xA, 0x0
                                         ; DATA XREF: sub_8001F1DC+48?o
                db 0, 0, 0
aPrimitiveQueue:db "Primitive Queue %d", 0xA, 0x0
                                         ; DATA XREF: sub_8001F1DC+58?o
aDgdC:          db "dgd.c", 0x0        ; DATA XREF: sub_8001F284+F4?o
                dh 0
aCommandNotFoun:db "command not found", 0xA, 0x0
                                         ; DATA XREF: sub_8001FD40+58?o
                db 0
aProcXNotFound: db "PROC %X NOT FOUND", 0xA, 0x0
                                         ; DATA XREF: sub_8001FE80+64?o
                db 0
aProcDCancel:   db "proc %d cancel", 0xA, 0x0
                                         ; DATA XREF: sub_8001FF2C:loc_8001FF64?o
aTooManyArgsPro:db "TOO MANY ARGS PROC", 0xA, 0x0
aScriptCommandE:db "SCRIPT COMMAND ERROR %x", 0xA, 0x0
                                         ; DATA XREF: sub_80020118+E0?o
                db 0, 0, 0
aErrorInScript: db "ERROR in script", 0xA, 0x0
                                         ; DATA XREF: sub_80020118+F4?o
                db 0, 0, 0
aNotScriptData: db "NOT SCRIPT DATA !!", 0xA, 0x0
                                         ; DATA XREF: sub_80020228+28?o
jpt_80020454:   dw 0x8002045C         ; DATA XREF: sub_80020430+10?o
                dw 0x80020464         ; jump table for switch statement
                dw 0x8002046C
                dw 0x80020474
                dw 0x8002047C
                dw 0x80020484
                ...
                dw 0x80020554
                dw 0x8002056C
aGclWrongCodeX: db "GCL:WRONG CODE %x", 0xA, 0x0
                                         ; DATA XREF: sub_8002069C+1A8?o
                db 0
                dw 0
jpt_80020704:   dw 0x8002070C, 0x80020714, 0x80020788, 0x80020788, 0x80020788
                                         ; DATA XREF: sub_8002069C+50?o
                dw 0x8002083C, 0x8002076C, 0x80020798, 0x8002076C, 0x80020738  ; jump table for switch statement
                dw 0x80020738, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x800207AC, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x800207F0, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x800207C8
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C, 0x8002083C
                dw 0x8002080C
aSaveDataVersio:db "SAVE DATA VERSION ERROR!!", 0xA, 0x0
                                         ; DATA XREF: sub_80020EAC+3C?o
                db 0
aCrcError:      db "CRC ERROR !!", 0xA, 0x0
                                         ; DATA XREF: sub_80020EAC+64?o
                dh 0
                dw 0
jpt_800216BC:   dw 0x800216C4         ; DATA XREF: sub_80021634+74?o
                dw 0x800216E8         ; jump table for switch statement
                dw 0x800216E8
                dw 0x800216F4
                dw 0x80021714
                dw 0x800216C4
                dw 0x80021714
                dw 0x800216C4
jpt_800217A0:   dw 0x800217A8         ; DATA XREF: sub_8002171C+70?o
                dw 0x800217B0         ; jump table for switch statement
                dw 0x800217B0
                dw 0x800217B8
                dw 0x800217E8
                dw 0x800217A8
                dw 0x800217E8
                dw 0x800217A8
jpt_80021894:   dw 0x8002189C         ; DATA XREF: sub_800217F0+90?o
                dw 0x800218A8         ; jump table for switch statement
                dw 0x800218A8
                dw 0x800218B4
                dw 0x800218EC
                dw 0x8002189C
                dw 0x800218EC
                dw 0x8002189C
aWarningOldVers:db "Warning:old version hzm", 0xA, 0x0
                                         ; DATA XREF: sub_800219F4+34?o
                db 0, 0, 0
aBrfDat:        db "BRF.DAT", 0x0      ; DATA XREF: TEXT:8009D4CC?o
aDemoDat:       db "DEMO.DAT", 0x0     ; DATA XREF: TEXT:8009D4C4?o
                db 0, 0, 0
aVoxDat:        db "VOX.DAT", 0x0      ; DATA XREF: TEXT:8009D4BC?o
aZmovieStr:     db "ZMOVIE.STR", 0x0   ; DATA XREF: TEXT:8009D4B4?o
                db 0
aFaceDat:       db "FACE.DAT", 0x0     ; DATA XREF: TEXT:8009D4AC?o
                db 0, 0, 0
aRadioDat:      db "RADIO.DAT", 0x0    ; DATA XREF: TEXT:8009D4A4?o
                dh 0
aStageDir:      db "STAGE.DIR", 0x0    ; DATA XREF: TEXT:off_8009D49C?o
                dh 0
aPositionEnd:   db "Position end", 0xA, 0x0
                                         ; DATA XREF: sub_80021E2C+28?o
                dh 0
aDiskD:         db "DISK %d", 0xA, 0x0    ; DATA XREF: sub_80021E2C+40?o
                db 0, 0, 0
aIllegalDisk:   db "illegal DISK", 0xA, 0x0
                                         ; DATA XREF: sub_80021E2C+78?o
                dh 0
aCdfsSkipErrorD:db "CDFS: skip error %d %d %d", 0xA, 0x0
                                         ; DATA XREF: sub_80022090+E8?o
                db 0
asc_800105B4:   db "[T]", 0x0          ; DATA XREF: sub_80022264+280?o
asc_800105B8:   db ".", 0x0            ; DATA XREF: sub_80022264+290?o
                dh 0
aD:             db "[%d]", 0x0         ; DATA XREF: sub_80022264+530?o
                db 0, 0, 0
aFileSTopDSizeD:db "FILE %s : top %d size %d set %d", 0xA, 0x0
                                         ; DATA XREF: sub_8002297C:loc_80022AA8?o
                db 0, 0, 0
aPlaystation:   db "PLAYSTATION", 0x0  ; DATA XREF: sub_80022B5C+40?o
aMgs:           db "MGS", 0x0          ; DATA XREF: sub_80022B5C+A8?o
aMgsReadSectorD:db "MGS read_sector %d", 0xA, 0x0
